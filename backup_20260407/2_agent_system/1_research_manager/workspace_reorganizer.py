...
MOVE_RULES: List[Tuple[str, str]] = [
    ...
    ("config/innovation_prompt.md", "4_research_hypothesis/innovation_prompt.md"),
    ("config/program.md", "6_experiment_execution/pipeline/program.md"),
    ...
    ("code/power_models", "5_code_base/optimized/power_models"),
    ("code/test_model.py", "5_code_base/demo/test_model.py"),
    ("code/prepare_mtg_data.py", "6_experiment_execution/pipeline/prepare_mtg_data.py"),
    ("code/run_stage3_local.ps1", "6_experiment_execution/pipeline/run_stage3_local.ps1"),
    ("code/run_round_fixed_pipeline.py", "6_experiment_execution/pipeline/run_round_fixed_pipeline.py"),
    ("code/check_round2_deps.py", "6_experiment_execution/pipeline/check_round2_deps.py"),
    ("code/check_torch.py", "6_experiment_execution/pipeline/check_torch.py"),
    ("code/get_num_nodes.py", "6_experiment_execution/pipeline/get_num_nodes.py"),
    ("code/dynamic_mtg nn_model.py", "5_code_base/optimized/dynamic_mtg_nn_model.py"),
    ("code/chromedriver-win32.zip", "3_literature_workflow/crawler/chromedriver-win32.zip"),
    ("code/SERVER_DEPLOY.md", "8_knowledge_asset/docs/SERVER_DEPLOY.md"),
    ("code/SSH_SETUP.md", "8_knowledge_asset/docs/SSH_SETUP.md"),
    ("code/SSH_PUBKEY.txt", "8_knowledge_asset/docs/SSH_PUBKEY.txt"),
    ("code/SKILLS.md", "8_knowledge_asset/docs/SKILLS.md"),
    ("code/program.md", "8_knowledge_asset/docs/program.md"),
    ("data", "6_experiment_execution/data"),
    ("experiment", "6_experiment_execution/tuning_log/raw_runs"),
    ("literature", "3_literature_workflow/literature_asset"),
    ("hypothesis", "4_research_hypothesis/history"),
    ("knowledge_base", "8_knowledge_asset/knowledge_base"),
    ("memory", "8_knowledge_asset/iteration_memory/legacy_memory"),
    ("docs", "8_knowledge_asset/docs"),
    ("report", "8_knowledge_asset/final_report/history_report"),
    ("MTGNN", "5_code_base/baseline/MTGNN_root"),
    ("TimesNet", "5_code_base/baseline/TimesNet_root"),
    ("research_definition.md", "1_config/research/research_definition.md"),
    ("DARIS v3.docx", "8_knowledge_asset/docs/DARIS_v3.docx"),
    ("~$RIS v3.docx", "8_knowledge_asset/docs/~$RIS v3.docx"),
    ("README.md", "8_knowledge_asset/docs/README_legacy.md"),
]
