...
parser.add_argument('--dynamic_graph', type=str_to_bool, default=False,
...
parser.add_argument('--adaptive_dynamic_alpha', type=str_to_bool, default=False,
...
def main(runid):
    ...
    model = gtnet(args.gcn_true, args.buildA_true, args.gcn_depth, args.num_nodes,
                  ...
                  layer_norm_affline=True, dynamic_graph=args.dynamic_graph,
