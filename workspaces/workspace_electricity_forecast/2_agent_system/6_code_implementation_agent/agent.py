...
class CodeImplementationAgent(BaseAgent):
    ...
    # 基线模型代码路径
    BASELINE_PATHS = {
        "mtgnn": "5_code_base/baseline/mtgnn_model.py",
        "timesnet": "5_code_base/baseline/timesnet_model.py",
        "xgboost": "5_code_base/baseline/xgboost_model.py",
    }
    
    # 优化模型代码路径
    OPTIMIZED_PATHS = {
        "mtgnn": "5_code_base/optimized/mtgnn_model.py",
        "timesnet": "5_code_base/optimized/timesnet_model.py",
        "xgboost": "5_code_base/optimized/xgboost_model.py",
    }
...
请生成针对 {target_model} 的代码修改方案。"""
    ...
    def _parse_code_changes(self, response: str, target_model: str) -> List[Dict[str, Any]]:
        ...
        for i, code in enumerate(code_blocks):
            change = {
                "file": f"5_code_base/optimized/{target_model}_model.py",
                "code": code,
