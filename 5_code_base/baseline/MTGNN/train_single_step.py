...
parser.add_argument('--loss_type', type=str, default='l1', choices=['l1', 'mse', 'huber'],
...
parser.add_argument('--dynamic_graph', type=bool, default=False,
                    help='whether to enable dynamic adjacency gating')
parser.add_argument('--dynamic_graph_alpha', type=float, default=0.5,
                    help='blend ratio between static and dynamic adjacency')
parser.add_argument('--adaptive_dynamic_alpha', type=bool, default=False,
                    help='whether to adapt dynamic graph blend ratio by input variance')
...
def main():
    ...
    model = gtnet(args.gcn_true, args.buildA_true, args.gcn_depth, args.num_nodes,
                  ...
                  layer_norm_affline=False, dynamic_graph=args.dynamic_graph,
                  dynamic_graph_alpha=args.dynamic_graph_alpha,
                  adaptive_dynamic_alpha=args.adaptive_dynamic_alpha)
    ...
    if args.loss_type == 'huber':
        criterion = nn.SmoothL1Loss(beta=1.0, reduction='sum').to(device)
